                ...
                <div className="formulario2">
                    ...
                    <form onSubmit={async (ev) => {
                         ...
                         const funccion = async () => {
                            ...
                            let newReport = { researcher: researcher, authors:author, coauthor:coauthor, articleTitle:title, journalName:journal, doi:doi, volume:volume, firstPage:first, lastPage:last, yearPublished:date, comment:comment, complete:erased}  
                            const requestInit = {
                              method:'POST',
